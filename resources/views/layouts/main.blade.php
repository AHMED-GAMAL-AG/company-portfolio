                    ...
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        <div class="flex items-center md:order-2">
                            <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                                @if (app()->getLocale() == 'ar')
                                    <svg class="h-3.5 w-3.5 rounded-full mr-2" viewBox="0 0 512 512" id="flag-icon-css-de" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="900" height="600" xmlns:v="https://vecta.io/nano">
                                        <style>
                                            <![CDATA[
                                            .B {
                                                fill: #c09300
                                        ...
                                        <g transform="matrix(.233093 0 0 .233093 344.14087 97.43379)" fill="#fff" class="D">
                                            <path d="M457.602 879.344l293.822 272.762-20.918-495.38c-3.073-75.078-68.316-57.853-115.709-30.77-48.01 30.77-102.783 30.77-160.648 10.454-57.852 20.315-112.629 20.315-160.64-10.455-47.388-27.08-112.624-44.308-115.704 30.77l-20.931 495.381z"
                                            ...
                                            <path d="M467.684 933.657l41.24 187.715-13.547 13.536-14.154-10.463-23.39-167.392 9.849 167.392-13.544 17.228-13.54-17.228 9.85-167.392-23.383 167.392-14.168 10.463-13.533-13.536 41.233-187.716h27.087z" stroke-width="4.607" class="B" />
                                            ...
                                            <g transform="matrix(4.29012 0 0 4.29012 -1476.4279 -417.98899)">
                                                <path
                                                    ...
                                                    stroke-width="1.218" />
                                                <path d="M446.12 227.57s-2.235 16.428-6.43 21.094m9.96-21.524s-.863 16.623-3.764 21.956m6.894-21.286s0 18.192 1.098 21.289m2.862-20.389s.902 15.291 4.666 20.819" fill="none" stroke-width="1.27" />
                                                <path
                                            ...
                                            <path d="M454.042 985.868c140.039-107.708 128.031-265.487 128.031-265.487-3.695.739-7.205 1.108-10.9 1.108-29.375 0-99.437-16.805-115.782-38.151-17.509 19.32-89.106 38.151-118.296 38.151-3.695 0-7.39-.369-10.9-1.108 0 0-12.193 157.774 127.846 265.487z"
                                                stroke-width="4.934" />
                                            <path
                                            ...
                                            <g clip-path="url(#A)" transform="matrix(16.042066 0 0 16.042066 2325.4644 -2179.2848)" fill-rule="evenodd" class="C">
                            ...
                            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu">
                                <ul class="py-2 font-medium" role="none">
                                    <li>
                                        <a href="{{ route('lang.switch', ['locale' => 'en']) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                    ...
                                    <li>
                                        <a href="{{ route('lang.switch', ['locale' => 'ar']) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                            <div class="inline-flex items-center">
                                                <svg class="h-3.5 w-3.5 rounded-full mr-2" viewBox="0 0 512 512" id="flag-icon-css-de" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="900" height="600" xmlns:v="https://vecta.io/nano">
                                                    <style>
                                                        <![CDATA[
